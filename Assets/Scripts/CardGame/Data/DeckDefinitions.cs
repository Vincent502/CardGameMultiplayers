    ...
    public static class DeckDefinitions
    {
        ...
        public static IReadOnlyList<(CardData card, int count)> GetGuerrierDeck()
        {
            return new List<(CardData, int)>
            {
                ...
                (new CardData(CardId.ContreAttaque, "Contre-attaque", CardType.Rapide, 0, "Peut être joué uniquement après Parade. Inflige 5 dégâts à l'attaquant."), 3),
                (new CardData(CardId.Parade, "Parade", CardType.Rapide, 1, "Annule une attaque adverse. Peut être suivi par Contre-attaque."), 3),
